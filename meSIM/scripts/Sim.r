...
#SelEBV
nSires      =50    #Number of sires per generation
nDams       =1000  #Number of dams per generation
nGEN        =11    #Number generations
nSires_old  =5     #Number of sires from older generations used
nDams_old   =700   #Number of dams from older generations used
