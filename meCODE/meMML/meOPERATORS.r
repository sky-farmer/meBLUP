...
#-------------------------------------------------
    ...
    rp<-         function(x) Ax(x)[1:nap]-Fy[1:nap]                                         #r for phenotype equations
    rg<-         function(x) Ax(x)[(nap+1):(nap+na)]-Fy[(nap+1):(nap+na)]                   #r for hybrid equations
    rs<-         function(x) Ax(x)[(nap+na+1):(nap+na+nSNP)]-Fy[(nap+na+1):(nap+na+nSNP)]   #r for snp equations
